    ...
    messagesToSend.forEach(async (message) => {
      ...
      await addDoc(collection(fireStoreDB, "channels", chatRoomId, "messages"), {
        ...
        user: {
          _id: uid,
          name: displayName,
          avatar: profileImg != '' ? profileImg : 'https://firebasestorage.googleapis.com/v0/b/finding-e15ab.appspot.com/o/images%2FdefaultProfile.png?alt=media&token=233e2813-bd18-4335-86a6-c11f92c96fc6',
        },
      });
    });
  }, [chatRoomId, uid]);
